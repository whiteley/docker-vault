...
TLS_DEPOT_PATH=/vault/tls
mkdir -p ${TLS_DEPOT_PATH}

/usr/bin/certstrap --depot-path=${TLS_DEPOT_PATH} init --common-name "VaultCA" --passphrase ""
/usr/bin/certstrap --depot-path=${TLS_DEPOT_PATH} request-cert --common-name "Vault" --domain vault --passphrase ""
/usr/bin/certstrap --depot-path=${TLS_DEPOT_PATH} sign "Vault" --CA "VaultCA" --passphrase ""
cat ${TLS_DEPOT_PATH}/Vault.crt ${TLS_DEPOT_PATH}/VaultCA.crt | tee ${TLS_DEPOT_PATH}/Vault_Combined.crt
chown -R vault:vault ${TLS_DEPOT_PATH}
